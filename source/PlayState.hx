				...
				case 'philly':
					{
						...
						var city:FlxSprite = new FlxSprite(-90, -180).loadGraphic(Paths.image('philly/city', 'week3'));
						...
						var street:FlxSprite = new FlxSprite(-160, 100).loadGraphic(Paths.image('philly/street', 'week3'));
						add(street);
					}
				case 'limo':
					{
